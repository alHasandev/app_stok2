        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <input type="date" name="tgl_pembayaran" id="tgl_pembayaran" value="<?= date('Y-m-d') ?>" class="form-control">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <input type="number" name="belum_dibayar" id="belum_dibayar" class="form-control" readonly>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
